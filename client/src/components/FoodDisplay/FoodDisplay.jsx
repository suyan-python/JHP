          ...
          {sortedFilteredProducts.map((product) => (
            ...
            >
              ...
              <div className="p-2 text-center">
                ...
                <Link to={`/store/${product._id}`}>
                  <button className="mt-2 w-full py-2 rounded-full border border-bluee text-bluee font-medium text-sm transition-transform duration-300 hover:scale-105 hover:bg-bluee hover:text-white">
                    More Details
                  </button>
                </Link>
              </div>
