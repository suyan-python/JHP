...
export function WhyJHP() {
  ...
  return (
    <section className="bg-[#f7f3ed] py-20 px-4 sm:px-6 rounded-[40px] sm:rounded-[50px] lg:rounded-[70px] shadow-inner my-36">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-16 text-[#5B3A29]">
          Why JHP Coffee?
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((f, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-[#4B2E20]">
                {f.title}
              </h3>
