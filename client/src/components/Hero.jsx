    ...
    <>
      <div className="relative mt-40 mb-5">
        ...
        <div className="absolute inset-0 h-[55vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] xl:h-[90vh] brightness-75">
          <img
            className="w-full h-full object-cover rounded-[30px] sm:rounded-[40px] lg:rounded-[60px]"
            src={background}
            alt="Background"
          />
        </div>
        ...
        {/* Hero Content */}
        <div
          className="relative flex items-center justify-center text-center z-10 px-4 sm:px-6 lg:px-12 h-[55vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] xl:h-[90vh]"
          id="home"
        >
          <div className="max-w-3xl mx-auto text-white">
            ...
            <p className="text-sm sm:text-base md:text-lg mb-6 sm:mb-8 drop-shadow">
